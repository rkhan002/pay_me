// AUTO-GENERATED from packages/rules-engine/src/handView.ts — DO NOT EDIT.
...
import type { HandState, HandPhase } from "./handState.ts";
import type { MeldType } from "./melds.ts";
